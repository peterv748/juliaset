"""
    plotting the calculated Julia set and writing it to file
"""
...
def plot_juliaset(image_rect, im_size, image_temp, elapsed_time, iterations):
    """
    ...
    plt.title( "Julia set, image size (x,y): {0}".format(image_dimension))
    plt.savefig("julia set.png")
    plt.show()
    plt.close()
